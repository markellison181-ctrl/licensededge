...
export const metadata: Metadata = {
  title: "Pricing — LicensedEdge",
  description: "LicensedEdge pricing: Free weekly, $29/mo Pro daily + data, $99/mo Enterprise team + API.",
};
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 md:py-24 relative">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-gray-200 max-w-3xl mx-auto text-xl leading-relaxed mb-8">
            Start free. Upgrade when your needs grow. All plans include our core intelligence 
            that cannabis operators trust for staying ahead of regulation.
          </p>
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="group card-hover relative bg-gradient-to-br from-white/10 via-white/5 to-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 flex flex-col overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="text-gray-200 text-sm font-medium uppercase tracking-wide">Starter</div>
            <ContractIcon className="w-12 h-12 opacity-60 group-hover:opacity-100 transition-opacity" />
          </div>
          
          <div className="flex items-baseline gap-2 mb-2">
            <span className="text-5xl font-bold tracking-tight bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent">$0</span>
            <span className="text-gray-300 text-sm">forever</span>
          </div>
          <div className="text-gray-300 text-sm mb-8">Perfect for getting started</div>
          
          <ul className="space-y-4 text-sm text-gray-200 mb-8 flex-1">
            <li className="flex items-start gap-3"><IconCheck /> Weekly regulatory digest every Monday</li>
            <li className="flex items-start gap-3"><IconCheck /> Regulatory Alert of the Week</li>
            <li className="flex items-start gap-3"><IconCheck /> Top 5 state-by-state updates</li>
            <li className="flex items-start gap-3"><IconCheck /> License opportunity highlights</li>
            <li className="flex items-start gap-3"><IconCheck /> Market intelligence snapshot</li>
        ...
        <div className="group card-hover relative bg-gradient-to-br from-gold/20 via-gold/10 to-gold/5 backdrop-blur-xl border-2 border-gold/60 rounded-2xl p-8 flex flex-col overflow-hidden shadow-2xl transform hover:scale-105 transition-all duration-300">
          ...
          <div className="text-gray-300 text-sm mb-8">14-day free trial • Cancel anytime</div>
          
          <ul className="space-y-4 text-sm text-gray-100 mb-8 flex-1">
            <li className="flex items-start gap-3"><IconCheck /> Everything in Starter</li>
            <li className="flex items-start gap-3"><IconCheck /> <span><strong className="text-gold">Daily</strong> regulatory alerts</span></li>
            <li className="flex items-start gap-3"><IconCheck /> State-specific filters</li>
            <li className="flex items-start gap-3"><IconCheck /> Compliance calendar access</li>
            <li className="flex items-start gap-3"><IconCheck /> License deadline tracker</li>
          ...
          <CheckoutButton
            priceId="price_1T5xsrPs7Nw0EhG0JGHSyFXX"
            tier="pro"
          ...
          <p className="text-center text-gray-300 text-xs mt-3 flex items-center justify-center gap-2">
        ...
        <div className="group card-hover relative bg-gradient-to-br from-white/15 via-white/10 to-white/5 backdrop-blur-xl border border-white/30 rounded-2xl p-8 flex flex-col overflow-hidden shadow-2xl">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="text-gray-100 text-sm font-medium uppercase tracking-wide flex items-center gap-2">
              Enterprise
          ...
          <div className="flex items-baseline gap-2 mb-2">
            <span className="text-5xl font-bold tracking-tight bg-gradient-to-r from-white via-gray-100 to-gray-200 bg-clip-text text-transparent">$99</span>
            <span className="text-gray-300 text-sm">/month</span>
          </div>
          <div className="text-gray-300 text-sm mb-8">For teams • Advanced features</div>
          ...
          <ul className="space-y-4 text-sm text-gray-200 mb-8 flex-1">
            ...
            <li className="flex items-start gap-3"><IconCheck /> Custom state reports</li>
          ...
          <CheckoutButton
            priceId="price_1T5xsrPs7Nw0EhG0rxlQH0ch"
            tier="enterprise"
      ...
      <div className="max-w-4xl mx-auto mt-24">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300">Everything you need to know about LicensedEdge</p>
        </div>
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            {
              q: "Where does LicensedEdge get its data?",
              a: "We aggregate data from official state regulatory agencies across all 40+ legal cannabis states, including the California DCC, Colorado MED, New York OCM, and more. Our editorial team adds analysis, context, and insight.",
            },
            {
            ...
            <div key={i} className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg border border-white/20 rounded-xl p-6">
              ...
              <p className="text-gray-200 text-sm leading-relaxed ml-9">{item.a}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-24 text-center">
        <div className="bg-gradient-to-br from-gold/20 via-gold/10 to-transparent backdrop-blur-xl border border-gold/30 rounded-2xl p-12">
          ...
          <h3 className="text-2xl font-bold text-white mb-4">Ready to stay ahead of cannabis regulation?</h3>
          <p className="text-gray-200 mb-8 max-w-2xl mx-auto">
            Join cannabis operators, compliance officers, and investors who rely on LicensedEdge 
            for daily regulatory intelligence and licensing opportunities.
          </p>
